...
Adding stylesheet and javascript steps are important because if you don't follow/ add them, you will not see datetime picker for start and end date in Admin area and countdown timer on the Store page.
